...
function buildLookImagePrompt(layers, fit, skipKeys, gender, realKey) {
  ...
  /* 2026-09-15 — раньше sleeveNote/dressNote были в "tail" и резервировались
     ...
     (подсказки-подстраховки, не критичны сами по себе) → "без текста".
     Подсказки добавляются, только если после гарантированного контента ещё
     остаётся место — лучше без них, чем без самой куртки/низа в тексте. */
