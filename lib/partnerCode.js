/* ============================================================================
   ...
   генерация вынесена в отдельный admin-only эндпоинт (api/admin.js,
   action=generate-code) за ADMIN_KEY и никогда не выполняется в браузере.
...
module.exports = { generateCode: generateCode, verifyCode: verifyCode, sanitizeRef: sanitizeRef };
