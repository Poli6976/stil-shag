...
const VERIFY_PROMPT =
  ...
  'Если есть хотя бы одна ошибка — верни ИСПРАВЛЕННУЮ версию целиком, СТРОГО построчно в формате ' +
  '"Слой: значение" для всех слоёв в исходном порядке, затем строка "Почему: " — без вступлений, ' +
  'пояснений и упоминания того, что и почему исправлено.';
