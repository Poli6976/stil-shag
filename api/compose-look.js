...
const SYSTEM_PROMPT =
  ...
  LAYER_KEYS.join('\n') + '\n' +
  'Определи ТИП вещи с фото по её структуре и способу ношения, а не только по ткани/цвету: плотная, ' +
  'застёгивающаяся, надетая поверх другой одежды или в один слой на голое тело — это куртка/жакет/' +
  'кардиган ("Верхняя одежда"), а не рубашка, даже если материал похож на джинсовую рубашку. Тонкая, ' +
  'однослойная вещь без надетого поверх нее слоя — рубашка/футболка/топ ("Верх"). Если вещь с фото по ' +
  'типу — верхняя одежда, помести её описание в слой "Верхняя одежда", а для "Верх" опиши, что логично ' +
  'носить под ней (футболка, топ, водолазка и т.п.), не срисовывая с фото.\n' +
