...
(function () {
  ...
  function renderResult(data) {
    ...
    root.appendChild(el('span', 'wizard-result__badge', 'Собрано ИИ-стилистом · иллюстрация на модели'));
    root.appendChild(el('h2', null, 'Ваш образ'));
    root.appendChild(el('p', 'wizard-result__note',
      'Картинка ниже — иллюстрация того, как может выглядеть образ, а не фотография вас в готовом виде. ' +
      'Настоящую примерку на своём фото делают отдельные сервисы — если вам это важнее, спросите нас про Dressie AI.'
    ));
