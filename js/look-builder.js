...
(function () {
  ...
  function renderUpload() {
    ...
    var DEFAULT_STATUS = 'На фото должны быть вы (или любой человек) — в вещи, вокруг которой хотим собрать образ; так ИИ точно поймёт, что это за вещь. Лицо можно не показывать крупным планом. Результат — рисованный референс на условной модели, а не ваше фото в образе.';
